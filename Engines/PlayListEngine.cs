...
namespace Dynaframe3
{
    ...
    //        stopwatch.Start();
    //        Logger.LogComment("La playlist est en cours de rebuild");
    //        Playlist.Clear();
    ...
    //                {
    //                    PlayListItemType item = PlayListEngineHelper.GetPlayListItemTypeFromPath(file);
    //                    string type = "";
    //                    switch (item)
    //                    {
    ...
    //                // Essaye de shuffle la liste des médias
    //                mediaFiles = Helpers.ShuffleMediaElement(mediaFiles);
    //            }
    //            stopwatch.Stop();
    //            Logger.LogComment("Rebuilding playlist took: " + stopwatch.ElapsedMilliseconds + "ms.");
    ...
    //        Logger.LogComment("[info]: Nous essayons de passer au prochain media");
    //        var MediaFile = mediaFiles.FirstOrDefault(e => e.Id == MediaIndex);
    //        if (MediaFile == null)
    //        {
    //            MediaIndex = 1;
    //            Logger.LogComment("[Warn]: Erreur lors de la récupération du prochain média.. Repassage à l'index 1");
    //            MediaFile = mediaFiles.FirstOrDefault(e => e.Id == MediaIndex);        
    //        }
